...
const translations = {
  fr: {
    ...
    // Why Choose Us
    whyTitle: "Pourquoi CHGOURI CAR ?",
    whySubtitle: "Choisir notre agence de location de voiture à Marrakech, c'est opter pour un service de qualité, une flotte moderne et variée, ainsi que des avantages qui rendent votre expérience unique.",
    why1Title: "Flotte variée et moderne",
    why1Desc: "Nos véhicules sont bien entretenus, récents et équipés des dernières technologies pour assurer votre confort et sécurité.",
    why2Title: "Assistance Technique 7J/7",
    why2Desc: "Notre équipe dévouée est à votre écoute pour vous aider pendant votre séjour.",
    why3Title: "Tarifs compétitifs et transparents",
    why3Desc: "Nous offrons des prix de location de voitures attractifs sans frais cachés.",
    why4Title: "Flexibilité de location",
    why4Desc: "Que vous ayez besoin d’un véhicule pour une courte escapade ou un séjour prolongé, notre agence s’adapte à vos besoins.",
    ...
    marketingBullet1: "Assurance tout risque : Sans franchise.",
    marketingBullet2: "Kilométrages : illimités.",
    marketingBullet3: "Livraison et récuperation ville et aéroport Marrakech gratuite.",
  ...
  en: {
    ...
    // Why Choose Us
    whyTitle: "Why CHGOURI CAR?",
    whySubtitle: "Choosing our car rental agency in Marrakech means opting for quality service, a modern and varied fleet, as well as unique benefits.",
    why1Title: "Varied & Modern Fleet",
    why1Desc: "Our vehicles are well-maintained, recent, and equipped with the latest technologies to ensure your comfort and safety.",
    why2Title: "7/7 Technical Assistance",
    why2Desc: "Our dedicated team is at your disposal to help you throughout your stay.",
    why3Title: "Competitive & Transparent Rates",
    why3Desc: "We offer attractive car rental prices with zero hidden fees.",
    why4Title: "Rental Flexibility",
    why4Desc: "Whether you need a vehicle for a quick getaway or an extended stay, our agency adapts to your needs.",
    ...
    marketingBullet1: "Comprehensive insurance: Zero deductible.",
    marketingBullet2: "Mileage: Unlimited.",
    marketingBullet3: "Marrakech city and airport pickup and delivery: Free.",
